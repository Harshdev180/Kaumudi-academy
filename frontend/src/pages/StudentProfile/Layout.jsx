...
const Layout = () => {
  ...
  const notifications = [
    { id: 1, title: "Course Fee Paid", subtitle: "Level 1: Pravesha - Confirmed", time: "2 hours ago", details: { course: "Pravesha", amount: "₹5000", status: "Success", date: "25 Feb 2026" } },
    { id: 2, title: "New Study Material", subtitle: "Shloka Chanting PDF uploaded", time: "1 day ago", details: { material: "Bhagavad Gita Ch 2", format: "PDF", size: "1.2MB" } },
    { id: 3, title: "Class Rescheduled", subtitle: "Sanskrit Grammar moved to 5 PM", time: "2 days ago", details: { original: "4 PM", new: "5 PM", instructor: "Acharya Ram" } },
  ];
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        <header className="h-20 flex items-center justify-between px-4 md:px-10 bg-gradient-to-r from-[#f3e6c9] to-[#FBF4E2] border-b border-[#e6d5b8]/50 shrink-0 z-40">
          <div className="flex items-center gap-4">
             ...
             <h2 className="text-xl md:text-2xl font-bold capitalize text-[#74271E]">{pageTitle}</h2>
          </div>
          ...
          {selectedNotification && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-bold text-[#74271E]">{selectedNotification.title}</h3>
