    ...
    <>
        ...
        >
          <div style={styles.content}>
            ...
            <h1 style={styles.heading}>
              ...
              Timeless Wisdom <br />
              of{" "}
              <span style={{ color: GOLD, fontFamily: FONT_SERIF }}>
                Sanskrit
              </span>
            </h1>
      ...
      <div style={styles.courseScrollWrapper}>
        <div ref={scrollRef} style={styles.scrollTrack}>
          {Array(8)
            .fill(
              "ज्ञानप्रदीपः — Illuminating minds through Sanskrit wisdom 📜   ",
            )
            .map((text, i) => (
          ...
          <div style={styles.courseCards}>
            <div style={styles.courseCard}>
              ...
              <p style={styles.courseDesc}>
                Master the intricate structure of the Sanskrit language.
              </p>
            ...
            <div style={styles.courseCard}>
              ...
              <p style={styles.courseDesc}>
                Journey through poetic works of Kalidasa swamy and others.
              </p>
              <strong style={styles.courseLink}>LEARN MORE →</strong>
            </div>
            ...
            <div style={styles.courseCard}>
              ...
              <p style={styles.courseDesc}>
                Acquire modern fluency and conversational skills for daily life.
              </p>
              <strong style={styles.courseLink}>LEARN MORE →</strong>
            </div>
          </div>
        ...
        <div style={styles.missionContainer}>
          <div style={styles.missionLeft}>
            ...
            <p style={styles.missionParagraph}>
              Kaumudi Sanskrit Academy was founded to preserve the meticulous
              scholarly traditions of the past while making them accessible to
              the global student of today.
            </p>
            ...
            <div style={styles.missionFeaturesGrid}>
              ...
              <div style={styles.featureBox}>
                ...
                <p style={styles.featureDesc}>
                  Traditional methods tailored for modern cognitive learning
                  styles.
                </p>
              </div>
              ...
              <div style={styles.featureBox}>
                ...
                <p style={styles.featureDesc}>
                  Connecting Sanskrit enthusiasts across 50+ countries via
                  digital platforms.
                </p>
              </div>
              ...
              <div style={styles.featureBox}>
                ...
                <p style={styles.featureDesc}>
                  Access to rare manuscripts and curated digital study
                  materials.
                </p>
              </div>
            </div>
      ...
      <section style={styles.learningWrapper}>
        <div style={styles.container}>
          ...
          <p style={styles.learningSubtitle}>
            Choose the modality that fits your lifestyle, without compromising
            on quality.
          </p>
          ...
          <div style={styles.learningCards}>
            ...
            <div style={styles.gurukulCard}>
              <h3 style={styles.learningCardTitleDark}>
                Offline Gurukul Session
              </h3>
      ...
      <footer style={styles.footer}>
        <div style={{ ...styles.container, ...styles.footerGrid }}>
          <div>
            <h4 style={styles.footerTitle}>KAUMUDI</h4>
            <p style={styles.footerText}>
              Dedicated to the revival and preservation of Sanskrit scholarly
              traditions through authentic teaching methods.
            </p>
          </div>

          <div>
            <h4 style={styles.footerTitle}>Quick Links</h4>
            <a href="/courses" style={styles.footerLink}>
              Course Catalog
            </a>
            <a href="/workshops" style={styles.footerLink}>
              Upcoming Workshops
            </a>
            <a href="/research" style={styles.footerLink}>
              Research Papers
            </a>
            <a href="/faculty" style={styles.footerLink}>
              Academy Faculty
            </a>
          </div>
          ...
          <div>
            ...
            <a href="/resources/vocabulary" style={styles.footerLink}>
              Free Vocabulary Lists
            </a>
            <a href="/resources/manuscripts" style={styles.footerLink}>
              Manuscript Digital Archive
            </a>
            <a href="/resources/tools" style={styles.footerLink}>
              Grammar Tools
            </a>
...
/* ================= STYLES ================= */
const styles = {
  // Utility for keeping sections aligned
  container: {
    maxWidth: "1200px",
    margin: "0 auto",
    padding: "0 20px",
  ...
  onlineCard: {
    ...
    padding: "36px",
    flex: 1,
    maxWidth: "480px", // Prevent them from getting too wide
    borderRadius: "16px",
    textAlign: "left",
  ...
  testimonialCard: {
    ...
    display: "flex",
    flexDirection: "column",
    alignItems: "center", // Centers content horizontally inside card
  },
  ...
  footer: {
    background: "#74271E",
    padding: "80px 0 40px", // Removed horizontal padding here, handled by container
    color: "#f4e9dc",
    fontFamily: FONT_SERIF,
  },
