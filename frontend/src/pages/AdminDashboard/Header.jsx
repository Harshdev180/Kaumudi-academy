...
function Header({ showAlerts, setShowAlerts }) {
    ...
    const getTitle = () => {
        ...
        if (location.pathname.includes("student-inquiry")) return "Student Inquiry";
        if (location.pathname.includes("coupon")) return "Coupon Management";
        if (location.pathname.includes("student-management")) return "Student Management";
        if (location.pathname.includes("enroll")) return "Enrollment Management";
        if (location.pathname.includes("staff-salary")) return "Staff Management";
                            ...
                            <AnimatePresence>
                                {showAlerts && (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0, y: -20 }}
                                        className='absolute right-0 mt-3 w-80 rounded-3xl shadow-xl bg-gradient-to-br from-[#74271E] via-[#8a2a1f] to-[#5a1b14] text-white overflow-hidden'
                                    >

                                        <div className='px-5 py-4 bg-white/10 flex items-center justify-between'>
                                            <div className='flex items-start gap-3'>
                                                <BellRing className='w-5 h-5 text-[#D4AF37]' />
                                                <h4 className='font-semibold text-[#D4AF37]'>Smart Alerts</h4>
                                            </div>
                                        ...
                                        <div className='px-3 py-2 space-y-2 max-h-72 overflow-y-auto'>
                                            {latestAlerts.map((alert) => (
                                                <motion.div
                                                    ...
                                                    className='flex items-start gap-3 p-3 rounded-2xl bg-white/10 hover:bg-white/20 cursor-pointer'
                                                >
                                                    <div className='w-9 h-9 rounded-xl flex items-center justify-center bg-[#D4AF37]/20 text-[#D4AF37]'>
                                                        {getAlertIcon(alert.type)}
                                                    </div>
                                        ...
                                        <div
                                            ...
                                            className='px-5 py-3 text-center text-sm text-[#D4AF37] hover:bg-white/10 cursor-pointer'
                                        >
                                            View All Notifications →
                                        </div>
