...
import { Bell, Settings, BellRing, X, CreditCard, GraduationCap, MessageCircle, MoreHorizontal } from "lucide-react";
import {
  AlertTriangle,
  TicketPercent,
  Tag,
                ...
                {showAlerts && (
                  <motion.div
                    ...
                    <div className="px-3 py-2 space-y-2 max-h-72 bg-[#6b1d14] overflow-y-auto">
                      {notifications
                        .filter(n => activeAlertFilter === "all" || (n.type || "").toUpperCase() === activeAlertFilter.toUpperCase())
                        .slice(0, 4)
                        .map((alert) => (
                        <motion.div
                          key={alert._id}
                          ...
                          onClick={() => { 
                            setShowAlerts(false); 
                            navigate(`/admin/notifications?highlight=${alert._id}`); 
                          }}
