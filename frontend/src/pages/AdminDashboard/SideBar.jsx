...
//         { path: '/admin/lead', label: 'Lead Management', icon: <Users size={20} /> },
...
//         { path: '/admin/courses', label: 'Courses Management', icon: <BookOpen size={18} /> },
//     ];
...
//             {/* Sidebar */}
//             <aside
//                 className={` fixed inset-y-0 left-0 z-50 w-72 bg-[#FBF4E2] text-[#6b1d14] border-r border-[#b8973d]/20 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
//                 {/* Mobile close */}
//                 <button
//                     onClick={toggleSidebar}
//                     className="md:hidden absolute right-4 top-6 p-2 text-[#6b1d14]/60 hover:text-[#6b1d14]"
//                 >
//                     <X size={22} />
//                 </button>
...
//                     <div className="flex items-center gap-3 mb-2">
//                         <div className="bg-[#D4AF37]/90 p-2.5 rounded-xl shadow-inner">
//                             <BookOpen size={20} className="text-[#6b1d14]" />
//                         </div>
//                         <h1 className="font-serif font-extrabold text-2xl tracking-tight">
//                             KAUMUDI
//                         </h1>
//                     </div>
//                     <p className="text-[11px] uppercase tracking-widest font-bold text-[#6b1d14]/70 ml-1">
//                         Sanskrit Academy Admin
//                     </p>
//                 </div>
...
//                     <Link
//                         to="/admin/settings"
//                         className="flex items-center gap-4 px-4 py-3 rounded-xl text-sm text-[#6b1d14]/80 hover:bg-[#F3E6C9]"
//                     >
//                         <Settings size={18} />
//                         <span>Settings</span>
//                     </Link>
...
//                     <button
//                         className=" w-full mt-4 flex items-center justify-center gap-2 bg-[#F3E6C9] hover:bg-[#D4AF37] text-[#6b1d14] py-3.5 rounded-2xl text-xs font-bold transition-all border border-[#b8973d]/30 shadow-sm
//             "
//                     >
//                         <MdSupportAgent size={18} />
//                         Support
...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-72 bg-[#FBF4E2] text-[#6b1d14]  border-r border-[#b8973d]/20  flex flex-col h-screen  transition-transform duration-300 ease-in-out  ${isOpen ? 'translate-x-0' : '-translate-x-full'}  md:translate-x-0 `}>
                {/* Mobile close */}
                <button
                    onClick={toggleSidebar}
                    className="md:hidden absolute right-4 top-6 p-2 text-[#6b1d14]/60 hover:text-[#6b1d14]"
                ...
                <div className="mt-auto px-6 pb-6 flex-shrink-0">
                    <Link
                        to="/admin/settings"
                        className="flex items-center gap-4 px-4 py-3 rounded-xl text-sm text-[#6b1d14]/80 hover:bg-[#F3E6C9]"
                    >
