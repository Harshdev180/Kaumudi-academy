...
const courses = [
  { id: 1, title: "Mastering Paninian Grammar", price: "5,481", rating: "9.3", status: "Superb", reviews: "1,368", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400" },
  { id: 2, title: "Vedic Phonetics & Sound", price: "20,501", rating: "8.9", status: "Fabulous", reviews: "1,123", image: "https://images.unsplash.com/photo-1505664194779-8beaceb93744?w=400" },
  { id: 3, title: "Manuscript Decoding 101", price: "7,674", rating: "8.6", status: "Fabulous", reviews: "141", image: "https://images.unsplash.com/photo-1585776245991-cf89dd7fc73a?w=400" },
  { id: 4, title: "Classical Sanskrit Syntax", price: "7,369", rating: "8.1", status: "Very good", reviews: "668", image: "https://images.unsplash.com/photo-1532012197267-da84d127e765?w=400" },
  { id: 5, title: "Bhagavad Gita Analysis", price: "4,200", rating: "9.5", status: "Exceptional", reviews: "2,105", image: "https://images.unsplash.com/photo-1505664194779-8beaceb93744?w=400" },
  { id: 6, title: "Yoga Sutras of Patanjali", price: "8,999", rating: "8.7", status: "Fabulous", reviews: "892", image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400" },
];
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-white hover:shadow-md transition-shadow h-full flex flex-col">
        ...
        <div className="flex flex-col flex-grow">
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <span className="text-sm font-semibold text-gray-800">{course.status}</span>
            <span className="text-[11px] text-gray-400 font-medium">· {course.reviews}</span>
          </div>
          ...
          <div className="mt-auto pt-4 space-y-3">
            <div className="flex justify-end">
              <p className="text-[11px] text-gray-500">
                Starting from <span className="text-base font-bold text-gray-900 ml-1">₹ {course.price}</span>
              </p>
            </div>
    ...
    <section className="bg-[#F3EAD3] w-full py-12 px-4 relative group overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-baseline mb-8 px-3">
          <h2 className="text-2xl font-extrabold text-[#2D2922] tracking-tight">Courses students Suggestion</h2>
        </div>
