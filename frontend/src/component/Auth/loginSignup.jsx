...
import { Eye, EyeOff, GraduationCap, Languages, Sparkles, ScrollText, Bell, Flower2 } from 'lucide-react';
...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#f1e4c8] p-4 relative overflow-hidden font-serif">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-gray-300 text-sm italic font-light leading-relaxed">
                    {isLogin ? (
                      <>
                        <span className="text-[#b8973d] font-bold not-italic block mb-1">“सा विद्या या विमुक्तये”</span>
                        <span className="opacity-70">Knowledge is that which liberates.</span>
                      </>
                    ) : (
                      <>
                        <span className="text-[#b8973d] font-bold not-italic block mb-1">“न हि ज्ञानेन सदृशं पवित्रमिह विद्यते”</span>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <InputGroup label="Email Address " placeholder="shastri@kaumudi.com" type="email" />
                
                <div className="space-y-1.5">
                  <div className="flex justify-between px-1">
                    <label className="text-[10px] font-bold text-[#8c7a56] uppercase tracking-wider">Password </label>
                    {isLogin && <button className="text-[10px] font-bold text-[#b8973d] hover:underline transition-all">Forgot?</button>}
                  </div>
                ...
                >
                  <span className="relative z-10">{isLogin ? "Enter Gurukul" : "Create Account"}</span>
...
const InputGroup = ({ label, placeholder, type = "text" }) => (
  <div className="space-y-1.5 flex-1">
    <label className="text-[10px] font-bold text-[#8c7a56] uppercase tracking-wider ml-1">{label}</label>
    <input 
      type={type} 
