...
const HeroSection = () => {
  return (
    <div className="relative bg-[#5C1D13] rounded-2xl overflow-hidden text-white shadow-xl">
      ...
      <div className="relative p-8 md:p-12 space-y-4">
        ...
        <h1 className="text-3xl text-[#B18E40]  md:text-5xl font-bold leading-tight max-w-2xl">
          Advanced Paninian Grammar: Mahabhashya Study
        </h1>
        <p className="text-[#D9C5B2] text-lg max-w-xl italic">
