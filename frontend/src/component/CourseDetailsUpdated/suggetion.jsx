        ...
        <div className="p-6 flex flex-col flex-grow text-left">
          ...
          <div className="grid grid-cols-2 gap-2 py-2 border-t border-gray-50 mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-gray-700">{course.duration || "Self-paced"}</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-blue-50 rounded-lg">
                <BarChart2 size={14} className="text-[#6b1d14]" />
              </div>
              <span className="text-xs font-semibold text-gray-700">{course.level || "Beginner"}</span>
            </div>
          </div>
          ...
          <div className="mt-auto pt-4 flex justify-between items-center border-t border-gray-50">
            <div className="flex flex-col">
                <span className="text-[10px] text-gray-400 uppercase font-bold tracking-tighter">Investment</span>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                navigate(`/coursedetail/${course._id || course.id}`, { state: { course } });
